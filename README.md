...
22. Реализовать ресурсы для получения информации о всех книгах, определенной книге, BooksRes и BookRes соответсвенно, реализовать проверку на наличие api ключа в запросе
...
3. Перейди на страницу регистрации по ссылке ```New here? Register.``` или по [ссылке](https://flask-online-library.herokuapp.com/user/register). Вам будет представлена форма регистрации, вам нужно будет ввести почту, пароль и подтверждение пароля.
